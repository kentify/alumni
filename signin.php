      ...
      <div class="row">
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
          <div class="card card-signup" style="margin-top: -20px;">
            <form class="form-login" method="post" id="login-form" style="">
              <div class="header text-center" style="background-color: transparent; box-shadow: none; margin-top:-70px; padding-bottom: 0;">
                <h4 class="card-title"><img src="img/norsu.png" style="width: 130px;"></h4>
              </div>
              <p class="description text-center">Login into your own account.</p>
              <div class="card-content">
                ...
                <div class="input-group">
                  ...
                  <input  autofocus="autofocus"  type="text" class="form-control" placeholder="Username" name="username" id="username">
                </div>
              ...
              <div style="width: 65%; margin: 0 auto;" class="footer text-center">
                <button align="center" style="margin: 0 auto;" name="login_button" id="login_button" class="btn btn-info btn-block"><i style="font-weight: bold;" class="material-icons">lock</i><span align="center" style="font-size: 13px; margin: 0 auto;"> Login</span></button><br>
              </div>
              <div style="width: 65%; margin: 0 auto;" class="footer text-center">
              <p>Don't have account? <a href="signup.php">Register now!</a></p>
            </div>
            </form>
          </div>
        </div>
